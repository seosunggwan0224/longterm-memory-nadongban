...
def gpt3_embedding(content, model='text-embedding-ada-002'):
    client = OpenAI(api_key=open_file('key_openai.txt'))
...
'''
pinecone.init(api_key=open_file('key_pinecone.txt'), environment='us-east-1')
vdb = pinecone.Index("nadongban")
'''

pc = Pinecone(api_key="f907c6e2-ca80-4c89-9614-be9befcad63e")
index = pc.Index("nadongban")
